        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text17">Storage Tracking</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="footer4-text21">Virtual Appointments</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="footer4-row">
            ...
            <div className="footer4-footer-links">
              ...
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer4-text14">Terms of Use</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
...
Footer4.defaultProps = {
  ...
  link4: undefined,
  link1: undefined,
  logoAlt: 'Saudi Medical Care System',
  link5: undefined,
  link3: undefined,
