          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text16">Schedule Appointment</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text20">Features</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text18">
                                  Explore the features we offer for medical care
                                  institutions.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text15">
                                  Discover the services we provide for Saudi
                                  medical companies.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text15">
                            Discover the services we provide for Saudi medical
                            companies.
                          </span>
                        </Fragment>
                      )}
